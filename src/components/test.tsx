...
//         watch,
//     } = useForm({
//         resolver: zodResolver(formSchema), // Χρησιμοποίησε για validator το zod schema
...
//                         <textarea type="text" name="description" id="description" placeholder="Type your message" onChange={handleChange} value={values.description}
...
//                         <button className="border border-button-border-blue rounded-lg text-button-text-blue font-semibold text-sm px-3 py-2 mt-3">CANCEL</button>
